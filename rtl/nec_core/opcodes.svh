...
task process_ROOT(input bit [7:0] q);
  casex(q)
    ...
    8'b01101010: begin
      ...
      d.width <= BYTE;
      d.push <= STACK_OPERAND;
      // HAND-APPLIED from opcodes.yaml (gen_decode.py needs the missing
      // `anytree` module on this machine): PUSH imm8 SIGN-extends. See the
      // yaml comment and HANDOFF #76. Regenerating reproduces this line.
      d.source0 <= OPERAND_IMM_EXT;
      state <= TERMINAL;
    end
    8'b01101000: begin
